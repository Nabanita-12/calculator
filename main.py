...
display = tk.Label(root, width=20, height=2, font=("Arial", 20), anchor="e")
...
def button_click(number):
    ...
    update_display(current + str(number))
...
button_clear = tk.Button(root, text="C", padx=20, pady=20, command=lambda: update_display(""))

# create the equals button
button_equals = tk.Button(root, text="=", padx=20, pady=20, command=lambda: update_display(eval(display.cget("text"))))
